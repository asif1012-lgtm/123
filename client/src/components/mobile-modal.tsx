      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="space-y-4 py-4 text-center">
          ...
          <p className="text-[#65676B]">
            Para la mejor experiencia y seguridad, por favor use una laptop o computadora para completar el proceso de verificación.
          </p>
          <div className="pt-4">
            ...
            >
              ...
              Contacte a nuestro agente por WhatsApp
            </Button>
          </div>
        </div>
      </DialogContent>
